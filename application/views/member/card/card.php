            ...
            <form method="POST" action="<?=base_url()?>card/topupproses">
                ...
                <div class="container" style="margin-bottom: 8rem;">
                    <div class="app-container py-5 ">
                        <h3 class="text-center text-red-blip fw-bolder f-poppins mt-5 pt-5">Confirmation details</h3>
                    ...
                    <?php $this->load->view("tamplate/banner-nofiat-balance"); ?>
                        ...
                        <div class="mt-5 f-poppins">
                            <div class="d-flex justify-content-between align-items-center card-balance my-1">
                                ...
                                <div class="text-blue-freedy d-flex align-items-center justify-content-end">
                                    ...
                                    <i id="eye-toggle" class="ri-eye-line text-red-blip pe-auto"></i>
                                </div>
                            </div>
                            ...
                            <div class="d-flex justify-content-between my-1 card-cvv">
                                ...
                                <div class="d-flex align-items-center justify-content-end">
                                    ...
                                    <i id="eye-toggle2" class="ri-eye-line text-red-blip pe-auto"></i>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="my-5 row">
                            <div class="col-12 text-topup-card">
                                ...
                                <?php } ?>
                                <div class="mt-5 wrap-border-topup-txt p-3 p-md-4 col-10 mx-auto">
                                    <h1 class="text-blue-freedy fw-bolder f-poppins text-center" style="color:#B90B0B">
                                        Top up Card
                                    </h1>
