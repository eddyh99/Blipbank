            ...
            <div class="container " style="margin-bottom: 8rem;">
                <div class="app-container mt-5 py-5 d-flex flex-column justify-content-center align-items-center ">
                    <div class="d-flex flex-column justify-content-center align-items-center">
                        <img src="<?= base_url() ?>assets/img/logobliponly.svg" alt="mylogo" style="width: 100px;">
                    </div>
                    <h1 class="text-center f-poppins text-red-blip mt-2 mb-5">Payment Succeeded</h1>
        ...
        <div class="col-12 col-lg-8 col-xl-6">
            <div class="container" style="margin-bottom: 8rem;">
                <div class="app-container py-5 ">
                    <h3 class="text-center text-red-blip fw-bolder f-poppins mt-5 pt-5">Summary</h3>
                        ...
                        <?php if($requestcard_physical == 'requestcard_physical') {?>
                            <div class="row my-5 ">
                                <div class="text-topup-card ">
                                    ...
                                    <?php } ?>
                                    <h1 class="text-red-blip fw-bolder f-poppins text-center ">
